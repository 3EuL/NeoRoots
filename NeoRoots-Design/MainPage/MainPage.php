...
<head>
    ...
    <link rel="shortcut icon" href="Logos/LogoEmpresa.png" type="image/x-icon">
...
<body>
    ...
    <section id="Home">
        <div class="nav">
            ...
            <img src="../Logos/LogoProyecto.png" alt="">
             ...
             <ul>
                ...
                <li><a href="../Log-In/Login.php" class="Sign-In">Inicio de Sesión</a></li>
...
<section class="contact-section" id="Contacto">
    <div class="contact-container">
        ...
        <div class="Link" style="margin-top: 50px; text-align: center;">
            <a href="../Sign-In/Sign-In.php">SÚMATE AL CAMBIO</a>
        </div>
