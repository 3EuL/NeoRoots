          ...
          <div class="container-fluid">
            ...
            <div class="row">
              <?php
                ...
                $contenedores = $conn->query("SELECT COUNT(*) as total FROM containers")->fetch_assoc()['total'];
                $promedio = $conn->query("SELECT AVG(50) as avg")->fetch_assoc()['avg'];
                $residuos = $conn->query("SELECT COUNT(*) * 10 as total FROM containers")->fetch_assoc()['total'];
              ?>
              <!--begin::Col-->
              ...
              <div class="col-lg-3 col-6">
                ...
                <div class="small-box text-bg-danger">
                  <div class="inner">
                    <h3><?= round($promedio) ?><sup class="fs-5">%</sup></h3>
                    <p>Nivel Promedio</p>
                  </div>
              ...
              <div class="col-lg-7 connectedSortable">
                <div class="card mb-4">
                  <div class="card-header">
                    <h3 class="card-title">Residuos reciclados mensuales</h3>
                  </div>
