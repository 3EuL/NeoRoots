...
<head>
    ...
    <link rel="stylesheet" href="/NeoRoots/CSS/Login.css">
        ...
        <div class="hub">
            ...
            <form id="loginForm" method="post">
                ...
                <div class="data">
                    ...
                    <input type="text" name="login" id="user" placeholder="Ingresar Usuario o Correo">
                    ...
                    <input type="submit" value="No tengo cuenta" onclick="window.location.href='/NeoRoots/FrontEnd/Sign-In.php'">
